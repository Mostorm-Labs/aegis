...
def base_project():
    return {"schema_version":"0.3","project":{"id":"demo","name":"Demo","profile":"standard","required_layers":["problem","authority","verification"],"lifecycle_hint":"implementation"}}


def base_authorities():
    return {"schema_version":"0.3","authorities":[
...
def base_evidence():
    return {"schema_version":"0.3","evidence":[{"id":"ev-g1","type":"automated_test","ref":"ci://g1","status":"available","subject_ids":["G1"]}]}


def base_gates():
    return {"schema_version":"0.3","gates":[{"id":"G1","stage":"P34","verdict":"PASS","validity":"current","authority_ids":["arch-v1"],"evidence_ids":["ev-g1"]}]}


def base_integrations():
    return {"schema_version":"0.3","integrations":[]}
